...
urlpatterns = [
    ...
    path('api/recipientconfigbyid/<int:id>', RecipientDetail.as_view(), name='configure-recipients-by-id'),  #algydar
    ...
    path('api/mustpayconfigbyid/<int:id>', MustPayDetail.as_view(), name='configure-must-pays-by-id'),   ######    bergidar

...
class MustPay(models.Model):
    mustpay_adder = models.ForeignKey(User, verbose_name='Admin:', on_delete=models.SET_NULL, null=True, blank=True, to_field='username')
...
class MustPayReceipt(models.Model):
    ...
    payment_date = models.DateField(verbose_name='Alimentiň tölenen senesi:')
...
class Alimony(models.Model):
    ...
    began_paying = models.DateField(verbose_name='Alimenti tölän wagty:')
    ...
    executor_date = models.DateField(verbose_name='Önumçiligiň senesi:')
    must_pay = models.ForeignKey(MustPay, to_field='name_and_lastname', verbose_name='Bergidaryň ady we familiýasy:', on_delete=models.CASCADE, related_name='alimonies')
